(function (global, factory) {
	...
	function createSelectorHook(context = ReactReduxContext) {
	  ...
	  return function useSelector(selector, equalityFnOrOptions = {}) {
	    ...
	    const latestWrappedSelectorRef = React.useRef(wrappedSelector); // console.log(
	    ...
	    const cacheWrapper = React.useRef({
	      cache
	    });
	    useIsomorphicLayoutEffect(() => {
	      cacheWrapper.current.cache = cache;
	    });
	    const subscribeToStore = React.useMemo(() => {
	...
	function createTag(name) {
	  return createCell(null, neverEq, name);
	}
