...
var _autotracking = require("../utils/autotracking/autotracking");
...
function createSelectorHook(context = _Context.ReactReduxContext) {
  ...
  return function useSelector(selector, equalityFnOrOptions = {}) {
    ...
    const latestWrappedSelectorRef = (0, _react.useRef)(wrappedSelector); // console.log(
    ...
    const cache = (0, _react.useMemo)(() => {
      ...
      const cache = (0, _autotracking.createCache)(() => {
    ...
    const cacheWrapper = (0, _react.useRef)({
      cache
    });
    (0, _useIsomorphicLayoutEffect.useIsomorphicLayoutEffect)(() => {
      cacheWrapper.current.cache = cache;
    });
    const subscribeToStore = (0, _react.useMemo)(() => {
